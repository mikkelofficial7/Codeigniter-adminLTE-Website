...
<head>
  ...
  <title>Galileo Gasing | Data Gaji Guru SD</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Gaji Guru SD
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datagajiguru/SD') ?>">Data Gaji</a></li>
        <li class="active">Gaji Guru SD</li>
      </ol>
    </section>
                  ...
                  <?php foreach($data_gaji as $post){?>
                    <tr>
                       ...
                       <?php if($post->status_gaji == "DITERIMA"){ ?>
                            ...
                            <td><?php echo anchor('admin/datagajiguru/hapus_gajiSD/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                            <td></td>
                       <?php }else { ?>
                            <td><span class="label label-danger"><?php echo $post->status_gaji?></span></td>
                            <td><?php echo anchor('admin/datagajiguru/hapus_gajiSD/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                            <td><?php echo anchor('admin/datagajiguru/ubah_gajiSD/'.$post->id,'<i class="ion-reply"></i> Ubah'); ?></td>
                        <?php } ?>
                    </tr>    
                  <?php }?>
                </tbody>
