...
<head>
  ...
  <title>Galileo Gasing | Data KBM SMA</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Kegiatan Belajar-Mengajar (KBM) SMA
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datakbm/SMA') ?>">Data KBM</a></li>
                ...
                <tbody>
                  <?php foreach($data_kbm as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/datakbm/hapus_SMA/'.$post->tanggal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
