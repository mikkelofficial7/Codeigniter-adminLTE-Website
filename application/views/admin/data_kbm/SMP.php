...
<head>
  ...
  <title>Galileo Gasing | Data KBM SMP</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Kegiatan Belajar-Mengajar (KBM) SMP
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datakbm/SMP') ?>">Data KBM</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Total KBM : <?php echo count($data_kbm);?></h3>
            </div>
            <br>
            <!-- /.box-header -->
                ...
                <tbody>
                  <?php foreach($data_kbm as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/datakbm/hapus_SMP/'.$post->tanggal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
