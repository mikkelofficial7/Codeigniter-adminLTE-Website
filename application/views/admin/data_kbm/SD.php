...
<head>
  ...
  <title>Galileo Gasing | Data KBM SD</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Kegiatan Belajar-Mengajar (KBM) SD
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datakbm/SD') ?>">Data KBM</a></li>
                ...
                <tbody>
                  <?php foreach($data_kbm as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/datakbm/hapus_SD/'.$post->tanggal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
