...
<head>
  ...
  <title>Galileo Gasing | Data Gaji Karyawan</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Gaji Karyawan Galileo Gasing
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datagaji/gaji') ?>">Data Gaji</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-cubes" aria-hidden="true"></i> Total Baris Gaji : <?php echo count($data_total_gaji);?></h3>
              <br><br>
              <h3 class="box-title"><i class="fa fa-cubes" aria-hidden="true"></i> Total Gaji Pegawai Bulan Ini : <?php date_default_timezone_set('Asia/Jakarta'); foreach($data_gaji as $post){ if($post->month == date('m') && $post->year == date('Y')){ echo $post->total; } }?></h3>
            </div>
            <br>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped bg-table">
                ...
                <tbody>
                  <?php foreach($data_total_gaji as $post){?>
                    <tr>
                       ...
                       <?php if($post->status_gaji == "DITERIMA"){ ?>
                            ...
                            <td><?php echo anchor('admin/datagaji/hapus_gaji/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                            <td></td>
                       <?php }else { ?>
                            <td><span class="label label-danger"><?php echo $post->status_gaji?></span></td>
                            <td><?php echo anchor('admin/datagaji/hapus_gaji/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                   			<td><?php echo anchor('admin/datagaji/ubah_gaji/'.$post->id,'<i class="ion-reply"></i> Ubah'); ?></td>
                        <?php } ?>
                    </tr>    
                  <?php }?>
                </tbody>
