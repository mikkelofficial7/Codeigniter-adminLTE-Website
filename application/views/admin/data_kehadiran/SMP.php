...
<head>
  ...
  <title>Galileo Gasing | Data Kehadiran SMP</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="overflow: auto;">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Kehadiran dan Penggantian Guru SMP
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datakehadiran/SMP') ?>">Data Kehadiran</a></li>
    ...
    <section class="content">
                  ...
                  <?php foreach($data_kehadiran as $post){?>
                    <tr>
                       ...
                       <?php }else { ?>
                        ...
                        <?php } ?>
                       <td><?php echo anchor('admin/datakehadiran/hapus_SMP/'.$post->tanggal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
                ...
                <table id="example2" class="table table-bordered table-striped bg-table">
                  ...
                  <tbody>
                      ...
                      <tr>
                         ...
                         <td><?php echo anchor('admin/datakehadiran/hapusGantiSMP/'.$post->tanggal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                      </tr>    
                    <?php }?>
                  </tbody>
                </table>
     ...
     <div class="col-md-6">
         <form role="form" method="POST" action="<?php echo base_url('admin/datakehadiran/gantiGuruSMP'); ?>">
              <div class="box-body">
