...
<head>
  ...
  <title>Galileo Gasing | Data Pembayaran SMA</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Record Pembayaran Bimbel SMA
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/databayaran/SMA') ?>">Data Pembayaran</a></li>
                  ...
                  <?php foreach($data_siswa as $post){?>
                    <tr>
                       ...
                       <?php }else { ?>
                        ...
                        <?php } ?>
                       <td><?php echo anchor('admin/databayaran/hapus_SMA/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
