...
<head>
  ...
  <title>Galileo Gasing | Data Pembayaran SMP</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Record Pembayaran Bimbel SMP
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/databayaran/SMP') ?>">Data Pembayaran</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-user" aria-hidden="true"></i> Total Siswa : <?php echo count($data_siswa);?></h3>
              <br><br>
              <h3 class="box-title"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> Total Pembayaran Bulan Ini : <?php date_default_timezone_set('Asia/Jakarta'); foreach($data_total as $post){ if($post->month == date('m') && $post->year == date('Y')) { echo $post->total; } }?></h3>
            </div>
            <br>
            <!-- /.box-header -->
                ...
                <tbody>
                  <?php foreach($data_siswa as $post){?>
                    <tr>
                       ...
                       <td><?php echo $post->kelas." ".$post->level." ".$post->bidang;?></td>
                       <td><?php echo $post->jumlah_biaya?></td>
                       <td><?php echo $post->tanggal_bayaran?></td>
                       <td><?php echo $post->tanggal_jatuh_tempo?></td>
                       <?php if($post->status_bayaran == "LUNAS"){ ?>
                            <td><span class="label label-success"><?php echo $post->status_bayaran?></span></td>
                       <?php }else { ?>
                            <td><span class="label label-danger"><?php echo $post->status_bayaran?></span></td>
                        <?php } ?>
                       <td><?php echo anchor('admin/databayaran/hapus_SMP/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
