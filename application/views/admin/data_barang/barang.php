...
<head>
  ...
  <title>Galileo Gasing | Data Barang</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Laporan Pemasukan dan Pengeluaran Budget Barang
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/databarang/barang') ?>">Data Barang</a></li>
        <li class="active">Input-Output</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-cube" aria-hidden="true"></i> Total Barang Di Tabel : <?php echo count($data_barang); ?></h3>
              <br><br>
              <h3 class="box-title"><i class="fa fa-cube" aria-hidden="true"></i> Total Barang Bulan Ini : <?php date_default_timezone_set('Asia/Jakarta'); foreach($data_total_barang as $post){ if($post->month == date('m') && $post->year == date('Y')) { echo $post->count; } }?></h3>
            </div>
             <div class="box-header">
              <h3 class="box-title"><i class="fa fa-cube" aria-hidden="true"></i> Total Pengeluaran Budget Barang Bulan Ini : <?php date_default_timezone_set('Asia/Jakarta'); foreach($data_total_barang as $post){ if($post->month == date('m') && $post->year == date('Y')) { echo $post->total; } }?></h3>
            </div>
            <br>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped bg-table">
                ...
                <tbody>
                  <?php foreach($data_barang as $post){?>
                    <tr>
                       <td><?php echo $post->nama?></td>
                       <td><?php echo $post->jumlah?></td>
                       <td><?php echo $post->harga?></td>
                       <td><?php echo $post->tanggal?></td>
                       <td><?php echo anchor('admin/databarang/hapus_barang/'.$post->id,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
            ...
            <div class="col-md-6">
                  <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-life-ring" aria-hidden="true"></i> Masukkan Data Pengeluaran Anda</h3>
                  </div>
                  <form role="form" method="POST" action="<?php echo base_url('admin/databarang/masukDataBarang'); ?>">
                    <div class="box-body">
                      ...
                      <div class="form-group form-group-changepass">
                        <label for="exampleInputPassword1">Jumlah (dalam pack/satuan)</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="jumlah" placeholder="misalnya : 20">
                      </div>
                      <div class="form-group form-group-changepass">
                        <label for="exampleInputPassword1">Harga (dalam pack/satuan)</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="harga" placeholder="misalnya : 20000">
                      </div>
                      <div class="form-group form-group-changepass">
                        <label for="exampleInputPassword1">Tanggal</label>
                        <input type="date" class="form-control" id="exampleInputPassword1" name="tanggal" placeholder="tanggal pembelian">
                      </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer form-group-changepass">
                      <input type="submit" name="changepass" class="btn btn-danger" value="Masukkan data">
                    </div>
                  </form>
                  <?php if($alert == "error"){ ?>
                        <div class="alert alert-danger alert-dismissible" id="pass-alert">
                          ...
                          Field kosong atau format tidak sesuai
                       </div>
