...
<head>
  ...
  <title>Galileo Gasing | Data Ujian Siswa SD</title>
                ...
                <tbody>
                  <?php foreach($data_siswa as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/dataujian/hapus_SD/'.$post->id_soal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
