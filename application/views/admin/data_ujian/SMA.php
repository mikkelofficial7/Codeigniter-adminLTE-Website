...
<head>
  ...
  <title>Galileo Gasing | Data Ujian Siswa SMA</title>
  <link rel="icon" href="<?php echo base_url(); ?>admin/img/icon.ico" type="image/gif" sizes="16x16">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-files-o" aria-hidden="true"></i> Total Ujian Siswa : <?php echo count($data_siswa);?></h3>
            </div>
            <br>
            <!-- /.box-header -->
              ...
              <table id="example1" class="table table-bordered table-striped bg-table">
                ...
                <tbody>
                  <?php foreach($data_siswa as $post){?>
                    <tr>
                       <td><?php echo $post->id_soal?></td>
                       <td><?php echo $post->id_siswa?></td>
                       <td><?php echo $post->kelas." ".$post->level?></td>
                       <td><?php echo $post->nilai?></td>
                       <td><?php echo $post->kategori?></td>
                       <td><?php echo $post->waktu?></td>
                       <td><?php echo anchor('admin/dataujian/hapus_SMA/'.$post->id_soal,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>     
                  <?php }?>
                </tbody>
              </table>
