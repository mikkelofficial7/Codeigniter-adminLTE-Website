...
<head>
  ...
  <title>Galileo Gasing | Data Guru SMP</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/dataguru/SMP') ?>">Data Guru</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-users" aria-hidden="true"></i>  Total Guru : <?php echo count($data_guru);?></h3>
            </div>
            <br>
            <!-- /.box-header -->
                ...
                <tbody>
                  <?php foreach($data_guru as $post){?>
                    <tr>
                       ...
                       <td><img src = "<?php echo base_url(); ?><?php echo $post->foto?>" id="user-pic" alt="Teacher image"></td>
                       <td><?php echo anchor('admin/dataguru/hapus_SMP/'.$post->id_tutor,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                       <?php if($post->status == 'BELUM'){ ?>
                         <td><form role="form" method="POST" action="<?php echo base_url('admin/dataguru/verif_SMP/'.$post->id_tutor); ?>"><input type="submit" class="btn btn-danger" name="submit_verif" value="Verifikasi"></form></td>
                         <?php } else {?>
                         <td></td>
                        <?php } ?>
                    </tr>    
