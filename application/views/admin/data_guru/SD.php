...
<head>
  ...
  <title>Galileo Gasing | Data Guru SD</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/dataguru/SD') ?>">Data Guru</a></li>
                ...
                <tbody>
                  <?php foreach($data_guru as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/dataguru/hapus_SD/'.$post->id_tutor,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                        <?php if($post->status == 'BELUM'){ ?>
                         <td><form role="form" method="POST" action="<?php echo base_url('admin/dataguru/verif_SD/'.$post->id_tutor); ?>"><input type="submit" class="btn btn-danger" name="submit_verif" value="Verifikasi"></form></td>
                         <?php } else {?>
                         <td></td>
                        <?php } ?>
                    </tr>    
