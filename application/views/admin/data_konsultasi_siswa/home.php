...
<head>
  ...
  <title>Galileo Gasing | Data Konsultasi Siswa</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List Siswa Mengajukan Konsultasi</h3>
            </div>
            <br>
            <br>
            <script>  
                $(document).ready(function(){
                  ...
                  setInterval(function() {
                      $.get("<?php echo site_url();?>"+"admin/data_konsultasi_siswa/detail_konsul", function (pesan) {
                              $("#konsul-body").html(pesan);
                          });
                  }, 500);
                });
            </script>
