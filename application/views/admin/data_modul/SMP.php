...
<head>
  ...
  <title>Galileo Gasing | Data Modul SMP</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/dataModul/SMP') ?>">Data Modul</a></li>
          ...
          <!-- /.box-body -->
            <script>
                $(function() {
                  ...
                  { 
                      if(i == 46) continue;
                      $('#ebook-SMP').append('<div class="responsive"><div class="gallery"><a target="_blank" href="http://assets.annibuku.com/tn/201424071334'+i+'.jpg"><img src="http://assets.annibuku.com/tn/201424071334'+i+'.jpg" alt="Book Cover"></a></div></div>');
                  }
                  for (i = 7; i <= 9; i++)
                  { 
                      $('#link-ebook-SMP').append('<font size="4"><a href="http://bse.annibuku.com/kelas/'+i+'/smp/1"><button type="button" class="btn btn-info btn-flat margin">Ebook SMP kelas '+(i-6)+' disini</button></a></font>');
                  }
            });
          </script>
        <div class="col-md-6">
