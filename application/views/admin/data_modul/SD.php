...
<head>
  ...
  <title>Galileo Gasing | Data Modul SD</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/dataModul/SD') ?>">Data Modul</a></li>
          ...
          <div class="box">
            ...
            <?php foreach($modul as $post){
                    echo "<div class='input-group margin'>
                              <input type='text' class='form-control' value = 'Modul Belajar Kelas ".$post->kelas." ".$post->level."' readonly>
        ...
        <script>
            $(function() {
	            ...
	            { 
	            	if(i == 53) continue;
	            	if(i == 45) continue;
	  				$('#ebook-SD').append('<div class="responsive"><div class="gallery"><a target="_blank" href="http://assets.annibuku.com/tn/201306260629'+i+'.jpg"><img src="http://assets.annibuku.com/tn/201306260629'+i+'.jpg" alt="Book Cover"></a></div></div>');
				}
				for (i = 1; i <= 6; i++)
	            { 
	  				$('#link-ebook-SD').append('<font size="4"><a href="http://bse.annibuku.com/kelas/'+i+'/sd/1"><button type="button" class="btn btn-info btn-flat margin">Ebook SD kelas '+i+' disini</button></a></font>');
				}
			});
		</script>
		<div class="col-md-6">
