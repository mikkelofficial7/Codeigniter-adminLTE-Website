...
<head>
  ...
  <title>Galileo Gasing | Data Absensi Pegawai</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tabel Data Absensi Karyawan Galileo Gasing
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/absen_karyawan/dataEmployee') ?>">Data Absensi</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-user-secret" aria-hidden="true"></i> Total Absensi Karyawan : <?php echo count($employee);?></h3>
            </div>
            <br>
            <!-- /.box-header -->
                  ...
                  <?php foreach($employee as $post){?>
                    <tr>
                      <td><?php echo $post->id?></td>
                       ...
                       <td><?php echo anchor('admin/absen_karyawan/hapus_absen/'.$post->username,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                    </tr>    
                  <?php }?>
                </tbody>
              </table>
