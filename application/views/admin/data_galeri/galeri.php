...
<head>
  ...
  <title>Galileo Gasing | Galeri Info</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Upload Kegiatan Galileo Gasing
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/home') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('admin/datagaleri/galeri') ?>">Data Galeri</a></li>
      ...
      <div class="row">
          <div class="box">
            ...
            <script type="text/javascript">
              $(function() {
                 $("#galleryspin").css('visibility','hidden');

                 $("input:file").change(function (){
                   $("#galleryspin").css('visibility','visible');
                   setTimeout(function(){ $("#galleryspin").css('visibility','hidden'); }, 1000);
                 });

              });
            </script>
          	<?php echo form_open_multipart('admin/datagaleri/uploading');?>
           	<form role="form" method="POST" enctype='multipart/form-data' action="<?php echo base_url('admin/datagaleri/uploading'); ?>">
                <div class="boxs box-header with-border">
                  <h4><i class="fa fa-picture-o" aria-hidden="true"></i> Pilih Gambar Dari File &nbsp;&nbsp;<i class="fa fa-spinner fa-spin" id="galleryspin"></i></h4>
                </div>
                <div class="form-group form-group-changepass">
                  <br>
                  <label class="myUploadAva">
                    <button class="btn-upload">Unggah Foto Dari Gallery atau Seret Gambar Kesini</button>
                    <input type="file" name="berkas" id="fileToUpload galleryupload">
                  </label>
                </div>
                <br>
                <div class="box editor-gallery">
                  <div class="box-header">
                    <h3 class="box-title">Gallery Editor
                      <small>Tambahkan Deskripsi/Caption Sesuai Keinginan Kamu</small>
                    </h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body pad">
                      <textarea class="textarea isi" id="isi" name="desc" placeholder="Tambahkan Deskripsi Disini" required></textarea>
                  </div>
                </div>
                <br>
                <!-- /.box-body -->
                <div class="form-group form-group-changepass">
                  <input type="submit" name="changegaleri" class="btn btn-danger" value="Upload Foto">
                </div>
            </form>
            <?php if($alert == "error"){ ?>
                <div class="alert alert-danger alert-dismissible" id="pass-alert">
                  ...
                  Rasio File Size Maximum 1200 x 800
               </div>
        ...
        <div class="row">
	        <div class="box">
		        <div class="col-md-12">
		          	<div id = "box-gallery">
		          	<?php foreach($data_foto as $post){?>
		          		<div class="responsive">
						  <div class="gallery" width="200" height="150">
						      <img class="img-gallery" src="<?php echo base_url(); ?>data_admin\gambar_gallery\<?php echo $post->namafile?>" alt="<?php echo base_url(); ?><?php $post->namafile?>">
			    			  <div class="desc"><b><?php echo $post->deskripsi?></b></div>
			    			  <div class="gallery-tanggal"><?php echo $post->tanggal?></div>
			    			  <div id="btn-gallery-delete"><?php echo anchor('admin/datagaleri/hapus_foto/'.$post->namafile,'Hapus foto'); ?></div>
						  </div>
						</div>
					<?php }?>
		          	</div>
