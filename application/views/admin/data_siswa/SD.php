...
<head>
  ...
  <title>Galileo Gasing | Data Siswa SD</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/datasiswa/SD') ?>">Data Siswa</a></li>
                ...
                <tbody>
                  <?php foreach($data_siswa as $post){?>
                    <tr>
                       ...
                       <td><?php echo anchor('admin/datasiswa/hapus_SD/'.$post->id_siswa,'<i class="ion-trash-a"></i> Hapus'); ?></td>
                       <?php if($post->tanggal_jatuh_tempo == '0000-00-00'){ ?>
                        <td><form role="form" method="POST" action="<?php echo base_url('admin/datasiswa/tempo_SD/'.$post->id_siswa); ?>"><input type="date" name="exp_date"><br><br><input type="submit" class="btn btn-danger" name="submit_exp" value="Ubah"></form></td>
                        <?php } else{ ?>
                        <td></td>
                        <?php } ?>
                        <?php if($post->status == 'BELUM'){ ?>
                         <td><form role="form" method="POST" action="<?php echo base_url('admin/datasiswa/verif_SD/'.$post->id_siswa); ?>"><input type="submit" class="btn btn-danger" name="submit_verif" value="Verifikasi"></form></td>
                         <?php } else {?>
                         <td></td>
                        <?php } ?>
                    </tr>    
